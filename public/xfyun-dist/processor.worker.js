!(function () {
  ...
  (r.prototype.initialize = function () {
    ...
    this.fromSampleRate == this.toSampleRate
      ...
      : (this.fromSampleRate < this.toSampleRate ? ((this.lastWeight = 1), (this.resampler = this.compileLinearInterpolation)) : ((this.tailExists = !1), (this.lastWeight = 0), (this.resampler = this.compileMultiTap)),
    ...
    (self.onmessage = function (e) {
      ...
      if (('stop' === s && (self.postMessage({ frameBuffer: self.transData(self.frameBuffer), isLastFrame: !0 }), (self.frameBuffer = [])), 'message' === s)) {
        var l,
          u = a;
        if (self.frameSize) return (l = self.frameBuffer).push.apply(l, t(u)), self.frameBuffer.length >= self.frameSize && (self.postMessage({ frameBuffer: self.transData(this.frameBuffer), isLastFrame: !1 }), (self.frameBuffer = [])), !0;
